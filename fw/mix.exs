defmodule Fw.Mixfile do
  ...
  def application(target) do
    [mod: {Fw.Application, []}, env: [target: target], extra_applications: [:logger]]
  end
  ...
  def system("infinity_rpi0"),
    do:
      {:infinity_system_rpi0, ">= 0.0.0",
       github: "infinity-aps/infinity_system_rpi0", ref: "v1.0.0-rc.0", runtime: false}
  ...
  def aliases(_target) do
    [compile: "compile --warnings-as-errors", loadconfig: [&bootstrap/1]]
  end
